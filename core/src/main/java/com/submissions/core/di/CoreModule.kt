package com.submissions.core.di

import androidx.room.Room
import com.submissions.core.data.source.local.LocalDataSource
import com.submissions.core.data.source.local.room.MovieDatabase
...
val repositoryModule = module {
    ...
    single<IMovieRepository> { com.submissions.core.data.MovieRepository(get(), get(), get()) }
}