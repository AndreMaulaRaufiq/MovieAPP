...
class MovieRepository(
    ...
    override fun getAllMovie(): Flow<com.submissions.core.data.Resource<List<Movie>>> =
        object : com.submissions.core.data.NetworkBoundResource<List<Movie>, List<ItemResult>>() {
